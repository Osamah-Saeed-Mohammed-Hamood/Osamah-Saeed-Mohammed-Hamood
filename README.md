...
I'm **Osamah Saeed Mohammed**, a Computer Science & Information Technology student at **Ibb University**, passionate about building smart, scalable, and real-world software solutions using **Java**, **Python**, **C#**, **SQL Server**, **Dart**, and modern **Web Technologies**.  
I love working on intelligent desktop and mobile applications, experimenting with AI systems, and sharing my journey through social platforms.
...
- 💻 Passionate about **Mobile App Development**, **Desktop Applications**, and **AI**
- 🌐 Exploring **Web Development** with modern frameworks
- 🤖 Enthusiast in AI, automation, and smart solutions
- 🧠 Focused on building systems that solve real-life problems

---

### 📂 Featured Projects

- 🔧 **Employee Net** – A network-based employee management solution
- 🧠 **Faseeh** – An educational platform with user-friendly design
- 📋 **Mahami (مهامي)** – A personal task management app
...
- 🤝 Open for collaboration on academic or tech projects
- 🌍 Passionate about building a strong Arabic-speaking tech community
- 📩 Reach me on:
